...
export default function DeleteProduct({ open, handleClose, DeleteFunction, deleteData, isLoading }) {
  return (
    <Dialog
      open={open}
      onClose={handleClose}
    ...
    >
      <DialogTitle id='alert-dialog-title'>{`Delete product ${deleteData?.name}`}</DialogTitle>
      <DialogContent>
